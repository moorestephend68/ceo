...
export const FORMAT = {
  ...
  rounds: 10,
  cadence: '5m',
  /* Ranked tables are always the full game. The leaderboard is one pool and one
     record; a table with half the levers switched off would be scored against
     tables that had all of them, and the number would mean nothing. */
  level: 2,
  preset: 'standard',
};
